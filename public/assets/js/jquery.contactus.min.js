...
$jscomp.findInternal = function (b, d, a) {
    ...
    for (var c = b.length, e = 0; e < c; e++) {
        var k = b[e];
        if (d.call(a, k, e, b))return {i: e, v: k}
    }
    return {i: -1, v: void 0}
};
...
(function (b) {
    ...
    d.prototype.init = function () {
        ...
        this.settings.items.length ? (this.$element.append("\x3c!--noindex--\x3e"), this._initCallbackBlock(), "regular" == this.settings.mode && this._initMessengersBlock(), this.popups.length && this._initPopups(), this._initMessageButton(), this._initPrompt(), this._initEvents(), this.startAnimation(), this.$element.append("\x3c!--/noindex--\x3e"),
    ...
    d.prototype._initCallbackBlock = function () {
        var a = b("<div>", {class: "callback-countdown-block", style: this._colorStyle()}), c = b("<div>", {
            class: "callback-countdown-block-close", style: "background-color:" + this.settings.theme +
            "; color: #FFFFFF"
        });
        ...
        var d = b("<form>", {id: "arcu-callback-form", action: this.settings.ajaxUrl, method: "POST"}),
            ...
            f = b("<input>", {name: "action", type: "hidden", value: this.settings.action}),
            g = b("<input>", {name: "gtoken", class: "ar-g-token", type: "hidden", value: ""});
        h.append(f);
        h.append(g);
        ...
        var l = b("<div>", {class: "callback-countdown-block-timer_timer"});
        f.append(g);
        f.append(l);
        g = b("<div>", {class: "callback-countdown-block-sorry"});
        l = b("<p>" + this.settings.callSuccessText +
            "</p>");
        g.append(l);
        d.append(h);
        e.append(d);
    ...
    d.prototype._initCallbackFormFields = function (a) {
        ...
        b.each(c.settings.callbackFormFields, function (e) {
            var d = b("<div>", {class: "arcu-form-group arcu-form-group-type-" + c.settings.callbackFormFields[e].type + " arcu-form-group-" + c.settings.callbackFormFields[e].name + (c.settings.callbackFormFields[e].required ? " arcu-form-group-required" : "")}),
                h = "<input>";
            ...
            "dropdown" == c.settings.callbackFormFields[e].type && b.each(c.settings.callbackFormFields[e].values, function (a) {
                var d = c.settings.callbackFormFields[e].values[a], k = c.settings.callbackFormFields[e].values[a];
    ...
    d.prototype._initPopups = function () {
        var a = this, c = b("<div>",
            {class: "popups-block arcuAnimated"}), e = b("<div>", {class: "popups-list-container"});
    ...
    d.prototype._appendMessengerIcons = function (a) {
        ...
        b.each(this.settings.items, function (e) {
            ...
            g.text(this.title);
            f.append(g);
            "undefined" != typeof this.subTitle && this.subTitle && (g = b("<div>", {class: "arcu-item-subtitle"}),
    ...
    d.prototype._initPrompt = function () {
        var a = b("<div>", {class: "arcontactus-prompt arcu-prompt-" + this.settings.promptPosition}),
            c = b("<div>", {class: "arcontactus-prompt-close", style: this._backgroundStyle() + "; color: #FFFFFF"});
        c.append(this.settings.closeIcon);
    ...
    d.prototype._initEvents = function () {
        ...
        a.find(".arcontactus-message-button").on("mousedown", function (a) {
            ...
            if (c.settings.drag && a.pageX === c.x && a.pageY === c.y || !c.settings.drag) "regular" == c.settings.mode ? c._menuOpened || c._popupOpened || c._callbackOpened ? (c._menuOpened && c.closeMenu(), c._popupOpened && c.closePopup()) : c.openMenu() : c.openCallbackPopup(), a.preventDefault()
        });
        this.settings.drag &&
        (a.draggable(), a.get(0).addEventListener("touchmove", function (c) {
        ...
        a.find("#arcu-callback-form").on("submit", function (b) {
            b.preventDefault();
    ...
    d.prototype.startAnimation = function () {
        var a = this.$element, b = a.find(".icons-line"), d = a.find(".static"),
        ...
        var g = a.find(".icons-line>span").length, l = 0;
        this.stopAnimation();
    ...
    b.fn.contactUs = function (a) {
        ...
        return this.each(function () {
            var e = b(this), k = e.data("ar.contactus");
